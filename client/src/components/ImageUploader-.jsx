...
const ImageUpload = ({
  ...
  const validateFile = (file) => {
    if (!acceptedFormats.includes(file.type)) {
      setError(
        `Invalid file format. Accepted formats: ${acceptedFormats.map((f) => f.split("/")[1]).join(", ")}`,
      );
      return false;
    }
      ...
      {!preview ? (
        ...
        >
          <div className="drop-zone-content">
            ...
            <p className="drop-zone-text">
              <span className="browse-link">Click to upload</span> or drag and
              drop
            </p>
        ...
        <div className="preview-container">
          ...
          <div className="file-info">
            ...
            <p className="file-size">{(img.size / 1024).toFixed(1)} KB</p>
          </div>
        </div>
      )}
